...
# Variables
RELEASES_KEEP=5
RELEASES_PATH="/var/www/staging.mamaplaats.nl/current/releases"
ONLINE_PATH="/var/www/staging.mamaplaats.nl/current/current"
SHARED_PATH="/var/www/staging.mamaplaats.nl/current/shared"
...
cp $DEPLOY_PATH/application/config/database.staging.php $DEPLOY_PATH/application/config/database.php
cp $DEPLOY_PATH/application/bootstrap.staging.php $DEPLOY_PATH/application/bootstrap.php
