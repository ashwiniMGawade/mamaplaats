...
class __Mustache_b0caadcccc70e2f189fede6cb71f3408 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $indent . '            <div class="wrap">';
        $buffer .= "\n";
        $buffer .= $indent . '                <time datetime="2015-07-16 10:31:13">Thursday 16 Jul 2015</time>';
        $buffer .= "\n";
        $buffer .= $indent . '                <strong class="title"><a href="/lid/mamaplaats">Mamaplaats</a></strong>';
        $buffer .= "\n";
        $buffer .= $indent . '            </div>';
        $buffer .= "\n";
        $buffer .= $indent . '            <p>astesat</p>';
        $buffer .= "\n";
        $buffer .= $indent . '        </div>';
        $buffer .= "\n";
        $buffer .= "\n";
        ...
        $buffer .= $indent . '            <div class="wrap">';
        $buffer .= "\n";
        $buffer .= $indent . '                <time datetime="2015-07-16 10:26:53">Thursday 16 Jul 2015</time>';
        $buffer .= "\n";
        $buffer .= $indent . '                <strong class="title"><a href="/lid/mamaplaats">Mamaplaats</a></strong>';
        $buffer .= "\n";
        $buffer .= $indent . '            </div>';
        $buffer .= "\n";
        $buffer .= $indent . '            <p>tests</p>';
        $buffer .= "\n";
        $buffer .= $indent . '        </div>';
        $buffer .= "\n";
        $buffer .= "\n";
        ...
        $buffer .= $indent . '            <div class="wrap">';
        $buffer .= "\n";
        $buffer .= $indent . '                <time datetime="2015-07-16 10:20:38">Thursday 16 Jul 2015</time>';
        $buffer .= "\n";
        $buffer .= $indent . '                <strong class="title"><a href="/lid/mamaplaats">Mamaplaats</a></strong>';
        $buffer .= "\n";
        $buffer .= $indent . '            </div>';
        $buffer .= "\n";
        $buffer .= $indent . '            <p>this is the test message for concepten</p>';
        $buffer .= "\n";
        $buffer .= $indent . '        </div>';
        $buffer .= "\n";
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '			<input name="recipient_id" type="hidden" value="1">';
        $buffer .= "\n";
