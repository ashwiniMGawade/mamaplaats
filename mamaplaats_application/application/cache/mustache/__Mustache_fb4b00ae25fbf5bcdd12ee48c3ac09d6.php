...
class __Mustache_fb4b00ae25fbf5bcdd12ee48c3ac09d6 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/profile" class="list-group-item active">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Mijn startpagina';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/update/personal_info" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Persoonsgegevens';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/update/family_situation" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Gezinssituatie';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/update/interest" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Mijn interesses';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/update/own_detail" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Over jezelf';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/update/newsletter_settings" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Nieuwsbrief';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/update/change_password" class="list-group-item ">';
        $buffer .= "\n";
        ...
        $buffer .= $indent . '                            <div class="list-group">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/blog/index" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Blog bericht schrijven';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/blog/list" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Mijn Blogs';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/blog/list/concepts" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Mijn concepten';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/blog/most_read" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Meest gelezen blogs';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/blog/admin_blogs" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Blogs van Mamaplaats';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/blog/following" class="list-group-item ">';
        $buffer .= "\n";
        ...
        $buffer .= $indent . '                            <div class="list-group">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/follow/following" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Moeders die ik volg';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/follow/followers" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Moeders die mij volgen';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/follow/suggestions" class="list-group-item ">';
        $buffer .= "\n";
        ...
        $buffer .= $indent . '                            <div class="list-group">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/conversation/new" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Schrijf bericht';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/conversation/list?type=inbox" class="list-group-item ">';
        $buffer .= "\n";
        ...
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/conversation/list?type=outbox" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Postvak uit';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/conversation/list?type=draft" class="list-group-item ">';
        $buffer .= "\n";
        ...
        $buffer .= $indent . '                            <div class="list-group">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/review-products/suggestions" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Schrijf je in voor een testpanel';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/review-products/subscribed" class="list-group-item ">';
        $buffer .= "\n";
        ...
        $buffer .= $indent . '                            <div class="list-group">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/win/suggestions" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Schrijf je in voor een winactie';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="http://dev.mamaplaats.nl/user/win/subscribed" class="list-group-item ">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    Reeds voor ingeschreven';
        $buffer .= "\n";
        $buffer .= $indent . '                                    </a>';
