...
class __Mustache_0e03ddce3765532ce3d4716fbdeb265d extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        // 'show_script' section
        $buffer .= $this->sectionFc640188652a8ee60608f927978c48a0($context, $indent, $context->find('show_script'));
    ...
    private function sectionFc640188652a8ee60608f927978c48a0(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
