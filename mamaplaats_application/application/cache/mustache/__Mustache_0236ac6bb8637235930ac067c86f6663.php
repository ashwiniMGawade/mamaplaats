...
class __Mustache_0236ac6bb8637235930ac067c86f6663 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section2e5a8126b35b909cc0926e182d23878c($context, $indent, $context->findDot('section.blocks'));
        $buffer .= $indent . '							</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '						</table>';
        $buffer .= "\n";
