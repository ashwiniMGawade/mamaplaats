...
class __Mustache_fb4ecd084ea2d5fbedc49352c007c793 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '            <!--<div class="float-new-blog">class="advise-heading"-->';
        $buffer .= "\n";
        ...
        $buffer .= $indent . '            <!--</div>-->';
        $buffer .= "\n";
        $buffer .= $indent . '            <h1>aanmelden reviews</h1>';
        $buffer .= "\n";
        ...
        $buffer .= $this->section3f3ee65c825f07f4c81cf600545f6879($context, $indent, $context->find('review_products'));
        $buffer .= $indent . '		</div>';
        $buffer .= "\n";
        ...
        if (empty($value)) {
            ...
            $buffer .= "\n";
            $buffer .= $indent . '            Op dit moment zoeken wij geen testmoeders. Wil je er snel bij zijn als er een nieuw testpanel start? Schrijf';
            $buffer .= "\n";
        ...
        $buffer .= "\n";
        // 'reviewed_products' section
        $buffer .= $this->section7a5563ed00bcb61cbc6378d89f711ec8($context, $indent, $context->find('reviewed_products'));
        $buffer .= $indent . '		</div>';
        $buffer .= "\n";
        $buffer .= $indent . '	</section>';
        $buffer .= "\n";
