...
class __Mustache_a62a0c4cd4a896a8cb2f38e56e9ded16 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '			<textarea name="content" placeholder="JOUW BERICHT *" rows="5" cols="50">test with concept-&gt; new concept</textarea>';
        $buffer .= "\n";
