...
class __Mustache_35fd08cf87b5f1b8e28d139c9cbb8e77 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '				<input class="required" id="username" name="username" type="text" placeholder="Gebruikersnaam of Email" value="ashwini" tabindex="1">';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= $indent . '			<div class="form-item">';
