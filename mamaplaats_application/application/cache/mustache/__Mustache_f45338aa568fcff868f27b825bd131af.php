...
class __Mustache_f45338aa568fcff868f27b825bd131af extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '							<img src="http://dev.mamaplaats.nl/uploads/advertisements/advertisement-popup.jpg" alt="Advertentie Afbeelding">';
        $buffer .= "\n";
        $buffer .= $indent . '						</div>';
        $buffer .= "\n";
        $buffer .= $indent . '				</div>';
