...
class __Mustache_bdd4f67b897cd7489cab0232795cfca3 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'blog_list' section
        $buffer .= $this->section13653d9b839bea2dada09e131ed6a47f($context, $indent, $context->find('blog_list'));
        $buffer .= $indent . '    </div>';
        $buffer .= "\n";
    ...
    private function section13653d9b839bea2dada09e131ed6a47f(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <article class="item">
                ...
                <p>{{blog.excerpt}}</p>
                <a href="/blog/list/{{blog.id}}">Bewerken Blog</a>
            </article>
		';
            $buffer .= $this->mustache
                ->loadLambda((string) call_user_func($value, $source))
            ...
            foreach ($values as $value) {
                ...
                $buffer .= '</p>';
                $buffer .= "\n";
                $buffer .= $indent . '                <a href="/blog/list/';
