...
class __Mustache_6bf85e87cce9483190ed1d1cdac38fee extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '				<input class="required" id="username" name="username" type="text" placeholder="Gebruikersnaam of Email" value="testuser1" tabindex="1">';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= $indent . '			<div class="form-item">';
