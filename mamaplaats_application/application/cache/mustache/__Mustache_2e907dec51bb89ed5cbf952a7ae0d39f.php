...
class __Mustache_2e907dec51bb89ed5cbf952a7ae0d39f extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $indent . '                </figure>';
        $buffer .= "\n";
        $buffer .= $indent . '                <h4><a href="/blog/">akjsbddddddddddddddddddddddddddddddddddddddf</a></h4>';
        $buffer .= "\n";
        $buffer .= $indent . '                <p class="info">';
        $buffer .= "\n";
        $buffer .= $indent . '                    <a href="/lid/mamaplaats">Mamaplaats</a> -';
        ...
        $buffer .= $indent . '                </p>';
        $buffer .= "\n";
        $buffer .= $indent . '                <p>akjsbddddddddddddddddddddddddddddddddddddddfakjsbddddddddddddddddddddddddddddddddddddddfakjsbddddddd...</p>';
        $buffer .= "\n";
        $buffer .= $indent . '            </article>';
        $buffer .= "\n";
        $buffer .= $indent . '    </div>';
