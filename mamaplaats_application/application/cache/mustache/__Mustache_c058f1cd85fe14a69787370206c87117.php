...
class __Mustache_c058f1cd85fe14a69787370206c87117 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '		<input id="recipient" type="text" name="search-term" value="testtestest" placeholder="Zoek een moeder op voornaam, achternaam of gebruikersnaam" autocomplete="off">';
        $buffer .= "\n";
        $buffer .= $indent . '	</form>';
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '			<input id="recipient_id" name="recipient_id" type="hidden" value="95">';
        $buffer .= "\n";
        $buffer .= $indent . '			<textarea name="content" placeholder="JOUW BERICHT *" rows="5" cols="50">test</textarea>';
        $buffer .= "\n";
