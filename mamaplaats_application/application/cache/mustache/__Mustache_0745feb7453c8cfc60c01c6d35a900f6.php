...
class __Mustache_0745feb7453c8cfc60c01c6d35a900f6 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'blog_list' section
        $buffer .= $this->section3cad35b69ac948cb47bca91a9a490b7d($context, $indent, $context->find('blog_list'));
        $buffer .= $indent . '    </div>';
        $buffer .= "\n";
    ...
    private function section3cad35b69ac948cb47bca91a9a490b7d(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <article class="item">
                ...
                <p>{{blog.excerpt}}</p>
                <a href="/blog/list/{{blog.id}}">Bewerken</a>
            </article>
		';
            $buffer .= $this->mustache
                ->loadLambda((string) call_user_func($value, $source))
