...
class __Mustache_782d5ddc33b7d5529e94ac407ec41893 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $indent . '    </div>';
        $buffer .= "\n";
        $buffer .= $indent . '    <a href="#" onclick="return load_more.follwoing(15)" class="lazy-load-more">Klik hier om meer berichten te laden</a>';
        $buffer .= "\n";
