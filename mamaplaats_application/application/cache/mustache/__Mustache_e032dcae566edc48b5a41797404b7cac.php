...
class __Mustache_e032dcae566edc48b5a41797404b7cac extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'main_menu' section
        $buffer .= $this->section36719cfe9bcd68bac264b5f01cc4c267($context, $indent, $context->find('main_menu'));
        $buffer .= $indent . '	</ul>';
        $buffer .= "\n";
        $buffer .= $indent . '</nav>';
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        // 'main_menu' section
        $buffer .= $this->section9968b33fb781c1a62d9d1e158db10b16($context, $indent, $context->find('main_menu'));
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '		<div class="header-leaderboard" id=\'div-gpt-ad-1401978110761-1\'>';
        $buffer .= "\n";
        $buffer .= $indent . '			<script type=\'text/javascript\'>';
        $buffer .= "\n";
        $buffer .= $indent . '				googletag.cmd.push(function() { googletag.display(\'div-gpt-ad-1401978110761-1\'); });';
        $buffer .= "\n";
    ...
    private function section3b7cca000c616f34a137a04fa17bc562(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
    ...
    private function section83e44769464b08ebec871fd4e77966da(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
			<ul>
            ...
            foreach ($values as $value) {
                ...
                $buffer .= "\n";
                // 'sub_menu' section
                $buffer .= $this->section3b7cca000c616f34a137a04fa17bc562($context, $indent, $context->find('sub_menu'));
                $buffer .= $indent . '			</ul>';
                $buffer .= "\n";
                $context->pop();
            }
    ...
    private function section36719cfe9bcd68bac264b5f01cc4c267(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
		...
		';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= "\n";
                // 'active' section
                $buffer .= $this->section83e44769464b08ebec871fd4e77966da($context, $indent, $context->find('active'));
                $buffer .= $indent . '		</li>';
                $buffer .= "\n";
                $context->pop();
            }
    ...
    private function sectionFa634b4eea5ce87095831bb5d7711ea5(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
    ...
    private function section9968b33fb781c1a62d9d1e158db10b16(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            ...
            foreach ($values as $value) {
                ...
                $buffer .= "\n";
                // 'sub_menu' section
                $buffer .= $this->sectionFa634b4eea5ce87095831bb5d7711ea5($context, $indent, $context->find('sub_menu'));
                $buffer .= $indent . '                        </ul>';
                $buffer .= "\n";
                $buffer .= $indent . '                    </div>';
                $buffer .= "\n";
