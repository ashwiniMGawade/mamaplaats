...
class __Mustache_5717f3b616390b8bd8754ca65e049303 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $indent . '				</figure>';
        $buffer .= "\n";
        $buffer .= $indent . '				<h4><a href="/blog/">test 12121ss</a></h4>';
        $buffer .= "\n";
        $buffer .= $indent . '				<p class="info">';
        $buffer .= "\n";
        $buffer .= $indent . '					<a href="/lid/mamaplaats">Mamaplaats</a> -';
        $buffer .= "\n";
        $buffer .= $indent . '					<time datetime="2015-09-22 13:02:07">22 Sep 2015</time>';
        $buffer .= "\n";
        $buffer .= $indent . '				</p>';
        $buffer .= "\n";
        $buffer .= $indent . '				<p>adfasdf asdfsadf ...</p>';
        $buffer .= "\n";
        $buffer .= $indent . '			</article>';
        $buffer .= "\n";
        $buffer .= $indent . '			<article class="item">';
        ...
        $buffer .= $indent . '					<a href="/lid/mamaplaats">Mamaplaats</a> -';
        $buffer .= "\n";
        $buffer .= $indent . '					<time datetime="2015-09-22 14:21:43">22 Sep 2015</time>';
        $buffer .= "\n";
        $buffer .= $indent . '				</p>';
        $buffer .= "\n";
        $buffer .= $indent . '				<p>...</p>';
        ...
        $buffer .= $indent . '                    <a href="/lid/mamaplaats">Mamaplaats</a> -';
        $buffer .= "\n";
        $buffer .= $indent . '                    <time datetime="2015-09-30 08:02:20">30 Sep 2015</time>';
        $buffer .= "\n";
        $buffer .= $indent . '                </p>';
        $buffer .= "\n";
        $buffer .= $indent . '                <p>...</p>';
