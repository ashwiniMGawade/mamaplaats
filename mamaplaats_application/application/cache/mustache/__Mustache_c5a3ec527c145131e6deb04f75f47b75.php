...
class __Mustache_c5a3ec527c145131e6deb04f75f47b75 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'blocks' section
        $buffer .= $this->section109138659f6d025673cb10fad6677eff($context, $indent, $context->find('blocks'));
        $buffer .= $indent . '							</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '						</table>';
        $buffer .= "\n";
