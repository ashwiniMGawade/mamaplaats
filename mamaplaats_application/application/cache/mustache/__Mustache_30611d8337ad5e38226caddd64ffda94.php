...
class __Mustache_30611d8337ad5e38226caddd64ffda94 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '			    Er zijn op dit moment geen testpanels waar je je voor in kunt schrijven.';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= $indent . '		</div>';
