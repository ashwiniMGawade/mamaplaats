...
class __Mustache_7d5f3ae723dc30f234134cc681053766 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'blog_list' section
        $buffer .= $this->section5ce635c38f5cba5c4af7e0c9a11bc1b5($context, $indent, $context->find('blog_list'));
        $buffer .= $indent . '    </div>';
        $buffer .= "\n";
    ...
    private function section5ce635c38f5cba5c4af7e0c9a11bc1b5(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <article class="item">
                ...
                <p>{{blog.excerpt}}</p>
                <a href="/user/blog/list/{{blog.id}}">Bewerken Blog</a>
            </article>
		';
            $buffer .= $this->mustache
                ->loadLambda((string) call_user_func($value, $source))
            ...
            foreach ($values as $value) {
                ...
                $buffer .= '</p>';
                $buffer .= "\n";
                $buffer .= $indent . '                <a href="/user/blog/list/';
