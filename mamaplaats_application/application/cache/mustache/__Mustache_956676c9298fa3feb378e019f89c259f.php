...
class __Mustache_956676c9298fa3feb378e019f89c259f extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '                            <a href="/user/blog/index"><i class="glyphicon glyphicon-pencil"></i> Schrijf nieuwe blog</a>';
        $buffer .= "\n";
        $buffer .= $indent . '                        </div>';
        $buffer .= "\n";
