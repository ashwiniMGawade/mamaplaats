...
class __Mustache_adf46476bd0779c9104c64816d4ad086 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '			<textarea name="content" placeholder="JOUW BERICHT *" rows="5" cols="50">test with concept</textarea>';
        $buffer .= "\n";
