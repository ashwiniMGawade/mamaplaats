...
class __Mustache_28c600edbc2d38123cf57ddb8e9cc577 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '							<input name="name" class="span12 focused" id="name" type="text" value="awstest">';
        $buffer .= "\n";
        $buffer .= $indent . '						</div>';
        $buffer .= "\n";
        $buffer .= $indent . '					</div>';
        ...
        $buffer .= $indent . '						<div class="controls">';
        $buffer .= "\n";
        $buffer .= $indent . '							<input name="slug" class="span12 focused" id="slug" type="text" value="awstest">';
        $buffer .= "\n";
        $buffer .= $indent . '						</div>';
        $buffer .= "\n";
        $buffer .= $indent . '					</div>';
        ...
        $buffer .= $indent . '						<div class="controls">';
        $buffer .= "\n";
        $buffer .= $indent . '							<input name="title" class="span12 focused" id="title" type="text" value="awstest">';
        $buffer .= "\n";
        $buffer .= $indent . '						</div>';
        $buffer .= "\n";
        $buffer .= $indent . '					</div>';
        ...
        $buffer .= $indent . '						<div class="controls">';
        $buffer .= "\n";
        $buffer .= $indent . '							<textarea name="description" class="input-block-level tinymce" id="description" rows="8">&lt;p&gt;test&lt;/p&gt;</textarea>';
        $buffer .= "\n";
        $buffer .= $indent . '						</div>';
        $buffer .= "\n";
        $buffer .= $indent . '					</div>';
        ...
        $buffer .= $indent . '						<div class="controls">';
        $buffer .= "\n";
        $buffer .= $indent . '							<textarea name="about" class="input-block-level tinymce" id="about" rows="8">&lt;p&gt;test&lt;/p&gt;</textarea>';
        $buffer .= "\n";
        $buffer .= $indent . '						</div>';
        $buffer .= "\n";
        $buffer .= $indent . '					</div>';
        ...
        $buffer .= $indent . '						<div class="controls">';
        $buffer .= "\n";
        $buffer .= $indent . '							<input name="external_id" class="span12 focused" id="external_id" type="text" value="0">';
        $buffer .= "\n";
        $buffer .= $indent . '						</div>';
        $buffer .= "\n";
        $buffer .= $indent . '					</div>';
        ...
        $buffer .= "\n";
        $buffer .= $indent . '						<img class="img-polaroid" width="180" src="http://dev.mamaplaats.nl/image/coupon/shop/199_180x180.jpg" alt="Voorbeeld Foto"><br><br>';
        $buffer .= "\n";
        $buffer .= "\n";
