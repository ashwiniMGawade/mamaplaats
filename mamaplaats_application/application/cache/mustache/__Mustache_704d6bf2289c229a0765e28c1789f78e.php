...
class __Mustache_704d6bf2289c229a0765e28c1789f78e extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'user' section
        $buffer .= $this->sectionD40d294faaaedf28dbc433f3ab9a1e23($context, $indent, $context->find('user'));
        $buffer .= "\n";
    ...
    private function sectionD40d294faaaedf28dbc433f3ab9a1e23(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
