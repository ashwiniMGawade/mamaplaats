...
class __Mustache_c746fd999b9e4bb4e6a92ea9a3fc3bc0 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '			<a href="/lid/yosann" class="photo-wrap">';
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '                <strong class="title"><a href="/lid/yosann">Yosann</a></strong>';
        $buffer .= "\n";
        $buffer .= $indent . '            </div>';
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . 'Ik heb mijn gegevens ingevuld, een blog geschreven, ingeschreven voor een review en ik volg andere bloggers. Toch geeft hij aan dat maar 75% van mijn profiel compleet is. Ik zie geen vinkje staan bij volg moeders. Hoe kan dit?';
        $buffer .= "\n";
        $buffer .= "\n";
        $buffer .= $indent . 'Groeten Josan</p>';
        $buffer .= "\n";
        $buffer .= $indent . '        </div>';
        $buffer .= "\n";
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '                <input name="recipient_id" type="hidden" value="109876">';
        $buffer .= "\n";
