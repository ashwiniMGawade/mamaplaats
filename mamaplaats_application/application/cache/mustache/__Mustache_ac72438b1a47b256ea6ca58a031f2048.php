...
class __Mustache_ac72438b1a47b256ea6ca58a031f2048 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section6d469349f6abf0fcc94e3e5d3b5e9a26($context, $indent, $context->find('profile_complete'));
        $buffer .= $indent . '</div>';
    ...
    private function sectionDbd54c578f39f9dbb136f72dea2c0b90(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
                            <option value="{{value}}"
    ...
    private function section6d469349f6abf0fcc94e3e5d3b5e9a26(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
	...
	';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionDbd54c578f39f9dbb136f72dea2c0b90($context, $indent, $context->find('sub_categories'));
                $buffer .= $indent . '                    </select>';
                $buffer .= "\n";
                $buffer .= $indent . '                </div>';
                $buffer .= "\n";
