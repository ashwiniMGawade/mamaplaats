...
class __Mustache_f4cb788bda9c69cf4a5e6ae300ab16c5 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="https://dev.mamaplaats.nl/user/review-products/subscribed" class="list-group-item active">';
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '					<a class="photo-wrap" href="/user/review/31780">';
        $buffer .= "\n";
        $buffer .= $indent . '						<b><img alt="Fleurville Mobi Stroller Bag" src="http://dev.mamaplaats.nl/image/review-product/fleurvile_232xn.png" width="232" height="303"></b>';
        $buffer .= "\n";
        $buffer .= $indent . '					</a>';
        $buffer .= "\n";
        $buffer .= $indent . '				</figure>';
        $buffer .= "\n";
        $buffer .= $indent . '				<h4><a href="/user/review/31780">Fleurville Mobi Stroller Bag</a></h4>';
        $buffer .= "\n";
        ...
        $buffer .= $indent . '...</p>';
        $buffer .= "\n";
        $buffer .= $indent . '				<a class="btn small " href="/user/review/31780">Schrijf Review</a>';
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '						<b><img alt="Test de HelloFresh Originalbox " src="http://dev.mamaplaats.nl/image/review-product/HF_232xn.jpg" width="232" height="303"></b>';
        $buffer .= "\n";
        $buffer .= $indent . '					</a>';
        $buffer .= "\n";
        $buffer .= $indent . '				</figure>';
        $buffer .= "\n";
        $buffer .= $indent . '				<h4><a href="">Test de HelloFresh Originalbox </a></h4>';
        $buffer .= "\n";
        $buffer .= $indent . '				<p>HelloFresh';
        $buffer .= "\n";
        $buffer .= $indent . '	Je hebt er vast al eens over gehoord: de beroemde&amp;nbsp;HelloFresh Box! Dit is een box vo...</p>';
        $buffer .= "\n";
        $buffer .= $indent . '				<a class="btn small grey disabled" href="">Ingeschreven</a>';
        $buffer .= "\n";
        $buffer .= $indent . '			</article>';
        $buffer .= "\n";
        $buffer .= $indent . '			<article class="item">';
        ...
        $buffer .= $indent . '					<a class="photo-wrap" href="">';
        $buffer .= "\n";
        $buffer .= $indent . '						<b><img alt="Test een complete wintersportvakantie in Oostenrijk" src="http://dev.mamaplaats.nl/image/review-product/pharos_232xn.jpg" width="232" height="303"></b>';
        $buffer .= "\n";
        $buffer .= $indent . '					</a>';
        $buffer .= "\n";
        $buffer .= $indent . '				</figure>';
        $buffer .= "\n";
        $buffer .= $indent . '				<h4><a href="">Test een complete wintersportvakantie in Oostenrijk</a></h4>';
        $buffer .= "\n";
        $buffer .= $indent . '				<p>Pharos Reizen';
        $buffer .= "\n";
        $buffer .= $indent . '	Pharos Reizen, van ANWB, is vernoemd naar een vuurtoren. Zoals de vuurtoren zeelieden...</p>';
        $buffer .= "\n";
        $buffer .= $indent . '				<a class="btn small grey disabled" href="">Ingeschreven</a>';
        $buffer .= "\n";
        $buffer .= $indent . '			</article>';
        ...
        $buffer .= $indent . '					<a class="photo-wrap" href="">';
        $buffer .= "\n";
        $buffer .= $indent . '						<b><img alt="RVS All-in-one PacificBaby thermosfles" src="http://dev.mamaplaats.nl/image/testpanel/odjzqk6a9govf0phk7p7_232xn.jpg" width="232" height="303"></b>';
        $buffer .= "\n";
        $buffer .= $indent . '					</a>';
        $buffer .= "\n";
        $buffer .= $indent . '				</figure>';
        $buffer .= "\n";
        $buffer .= $indent . '				<h4><a href="">RVS All-in-one PacificBaby thermosfles</a></h4>';
        $buffer .= "\n";
        $buffer .= $indent . '				<p>RVS All-in-one thermosfles van PacificBabyDit bijzonder innovatieve en duurzame product is ontwikkel...</p>';
        $buffer .= "\n";
        $buffer .= $indent . '				<a class="btn small grey disabled" href="">Ingeschreven</a>';
        $buffer .= "\n";
        $buffer .= $indent . '			</article>';
        ...
        $buffer .= $indent . '				<figure class="photo">';
        $buffer .= "\n";
        $buffer .= $indent . '					<a class="photo-wrap" href="/review/te-gek-de-fisher-price-swing">';
        $buffer .= "\n";
        $buffer .= $indent . '						<b><img alt="Fisher-Price wiegschommel review" src="http://dev.mamaplaats.nl/image/review/swing_232xn.jpg" width="232" height="303"></b>';
        $buffer .= "\n";
        $buffer .= $indent . '					</a>';
        $buffer .= "\n";
        $buffer .= $indent . '				</figure>';
        $buffer .= "\n";
        $buffer .= $indent . '				<h4><a href="/review/te-gek-de-fisher-price-swing">Fisher-Price wiegschommel review</a></h4>';
        $buffer .= "\n";
        $buffer .= $indent . '				<p>Met de Fisher-Price wiegschommel wordt je baby vermaakt met de gemotoriseerde mobile met knuffeltjes...</p>';
        $buffer .= "\n";
        $buffer .= $indent . '				<a class="btn small " href="/review/te-gek-de-fisher-price-swing">Review Live</a>';
        $buffer .= "\n";
        $buffer .= $indent . '			</article>';
        $buffer .= "\n";
        $buffer .= $indent . '			<article class="item">';
        ...
        $buffer .= $indent . '					<a class="photo-wrap" href="">';
        $buffer .= "\n";
        $buffer .= $indent . '						<b><img alt="Babycook Solo" src="http://dev.mamaplaats.nl/image/testpanel/v2bpm6hqs5ppxlwk5ymx_232xn.jpg" width="232" height="303"></b>';
        $buffer .= "\n";
        $buffer .= $indent . '					</a>';
        $buffer .= "\n";
        $buffer .= $indent . '				</figure>';
        $buffer .= "\n";
        $buffer .= $indent . '				<h4><a href="">Babycook Solo</a></h4>';
        $buffer .= "\n";
        $buffer .= $indent . '				<p>Klaar in 15 minuten in de extra grote kom t.o.v. de original versie. Door het ‘Easy Clip’ openin...</p>';
        $buffer .= "\n";
        $buffer .= $indent . '				<a class="btn small grey disabled" href="">Ingeschreven</a>';
        $buffer .= "\n";
        $buffer .= $indent . '			</article>';
        ...
        $buffer .= $indent . '					<a class="photo-wrap" href="">';
        $buffer .= "\n";
        $buffer .= $indent . '						<b><img alt="Babycook Duo" src="http://dev.mamaplaats.nl/image/testpanel/esrgczs7gtiulzvwq0jl_232xn.jpg" width="232" height="303"></b>';
        $buffer .= "\n";
        $buffer .= $indent . '					</a>';
        $buffer .= "\n";
        $buffer .= $indent . '				</figure>';
        $buffer .= "\n";
        $buffer .= $indent . '				<h4><a href="">Babycook Duo</a></h4>';
        $buffer .= "\n";
        $buffer .= $indent . '				<p>Met deze nieuwe Babycook Duo kun je tegelijkertijd van voor- tot nagerecht bereiden. Ook kan er tege...</p>';
        $buffer .= "\n";
        $buffer .= $indent . '				<a class="btn small grey disabled" href="">Ingeschreven</a>';
        $buffer .= "\n";
        $buffer .= $indent . '			</article>';
