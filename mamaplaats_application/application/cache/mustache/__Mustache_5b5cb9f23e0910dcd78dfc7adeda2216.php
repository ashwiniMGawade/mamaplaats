...
class __Mustache_5b5cb9f23e0910dcd78dfc7adeda2216 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'blog_list' section
        $buffer .= $this->sectionF5b0dd851a14f7addd9a0552653d0fe4($context, $indent, $context->find('blog_list'));
        $buffer .= $indent . '    </div>';
        $buffer .= "\n";
    ...
    private function sectionF5b0dd851a14f7addd9a0552653d0fe4(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <article class="item">
                ...
                <p>{{blog.excerpt}}</p>
                <a href="/user/blog/index/{{blog.id}}">Blog Bewerken</a>
            </article>
		';
            $buffer .= $this->mustache
                ->loadLambda((string) call_user_func($value, $source))
