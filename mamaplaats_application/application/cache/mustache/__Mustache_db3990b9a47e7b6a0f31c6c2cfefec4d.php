...
class __Mustache_db3990b9a47e7b6a0f31c6c2cfefec4d extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section109138659f6d025673cb10fad6677eff($context, $indent, $context->findDot('section.blocks'));
        $buffer .= $indent . '							</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '						</table>';
        $buffer .= "\n";
    ...
    private function section109138659f6d025673cb10fad6677eff(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
								<tr>
