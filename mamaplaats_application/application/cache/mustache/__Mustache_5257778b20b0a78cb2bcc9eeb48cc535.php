...
class __Mustache_5257778b20b0a78cb2bcc9eeb48cc535 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '				Dit account is nog niet geactiveerd. Kijk in je mail om dit account te activeren<br />';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '				<input class="required" id="username" name="username" type="text" placeholder="Gebruikersnaam of Email" value="testuser" tabindex="1">';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= $indent . '			<div class="form-item">';
