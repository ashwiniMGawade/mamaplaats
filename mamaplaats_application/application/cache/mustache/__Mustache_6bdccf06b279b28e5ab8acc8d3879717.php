...
class __Mustache_6bdccf06b279b28e5ab8acc8d3879717 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '				<textarea id="redactor_blog" name="content" data-blog-id="98731"></textarea>';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= "\n";
        ...
        $buffer .= $indent . '					<div class="form-item blog-form-btns">';
        $buffer .= "\n";
        $buffer .= $indent . '                            <a href="/user/blog/delete/98731" class="btn" onclick="return confirm(\'Weet je zeker dat je \\\'\\\' wil verwijderen?\');">Verwijder</a>';
        $buffer .= "\n";
        $buffer .= $indent . '					</div>';
        $buffer .= "\n";
        $buffer .= $indent . '				</div>';
