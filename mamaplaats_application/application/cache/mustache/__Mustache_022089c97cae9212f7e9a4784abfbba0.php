...
class __Mustache_022089c97cae9212f7e9a4784abfbba0 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'slides' section
        $buffer .= $this->section42159a6e399c501811ca7e166e06b784($context, $indent, $context->find('slides'));
        $buffer .= $indent . '							</tbody>';
        $buffer .= "\n";
        $buffer .= $indent . '						</table>';
        $buffer .= "\n";
    ...
    private function section42159a6e399c501811ca7e166e06b784(Mustache_Context $context, $indent, $value) {
        $buffer = '';
