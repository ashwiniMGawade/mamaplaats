...
class __Mustache_045588a4d9eb67bcc11f58474010bec8 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $indent . '                                    </a>';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="https://dev.mamaplaats.nl/user/update/newsletter_settings" class="list-group-item active">';
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '						<input type="checkbox" name="newsletter_subscription" checked="checked">';
        $buffer .= "\n";
