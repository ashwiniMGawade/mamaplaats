...
class __Mustache_7fd720b684f73739c9a35bd6374436e9 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'followers' section
        $buffer .= $this->sectionBcd9a77d6d5ecc3bfa4db8ecec37abbe($context, $indent, $context->find('followers'));
        $buffer .= $indent . '</div>';
    ...
    private function sectionBcd9a77d6d5ecc3bfa4db8ecec37abbe(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
	<div class="blogger">
