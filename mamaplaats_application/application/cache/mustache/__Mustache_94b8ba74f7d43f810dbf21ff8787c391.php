...
class __Mustache_94b8ba74f7d43f810dbf21ff8787c391 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '		name moet gevuld zijn<br />Omschrijving moet gevuld zijn<br />status moet gevuld zijn<br />';
        $buffer .= "\n";
        $buffer .= $indent . '	</div>';
        $buffer .= "\n";
        $buffer .= $indent . '</div>';
