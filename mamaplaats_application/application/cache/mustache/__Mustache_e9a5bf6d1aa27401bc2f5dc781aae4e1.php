...
class __Mustache_e9a5bf6d1aa27401bc2f5dc781aae4e1 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->sectionBe14d6724935ff3261fc6091eff6f7dc($context, $indent, $context->find('category_slug'));
        $buffer .= "\n";
    ...
    private function sectionBe14d6724935ff3261fc6091eff6f7dc(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = ' var advise_category = \'{{category_slug}}\'; ';
            $buffer .= $this->mustache
                ->loadLambda((string) call_user_func($value, $source))
                ->renderInternal($context, $indent);
        } elseif (!empty($value)) {
