...
class __Mustache_ac617e1dea953a343bc0053ebc450b99 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '				<textarea class="textarea_count" name="excerpt" id="excerpt" placeholder="Een duidelijke en korte inleiding waarover je blog gaat" maxlength="140">test blog which will test the entire working test blog which will test the entire working</textarea>';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '				<textarea id="redactor_blog" name="content" data-blog-id="98713"><p><font></font><font>test blog-which will test the entire working</font><font>test blog-which will test the entire working</font></p><p><font><br /></font></p><p><font>test blog-which will test the entire working test blog-which will test the entire working test blog-which will test the entire working</font><br /><br /><font>test blog-which will test the entire working</font><font>test blog-which will test the entire working</font><br /><font></font>test blog which will test the entire working<br /></p></textarea>';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= "\n";
