...
class __Mustache_cf2419c748456d7e8c617b172f474d4a extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->sectionC6baf6051be0d879fd70227049044678($context, $indent, $context->find('conversation_list'));
        $buffer .= $indent . '	</form>';
        $buffer .= "\n";
        $buffer .= $indent . '</div>';
        $buffer .= "\n";
    ...
    private function sectionC6baf6051be0d879fd70227049044678(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
		<fieldset>
