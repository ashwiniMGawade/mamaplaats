...
class __Mustache_60b63ec79ee18cd6d784980d0f60f180 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'blog_list' section
        $buffer .= $this->sectionC99ece04680a2dd19104adcb4d316069($context, $indent, $context->find('blog_list'));
        $buffer .= $indent . '    </div>';
        $buffer .= "\n";
    ...
    private function sectionC99ece04680a2dd19104adcb4d316069(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <article class="item">
