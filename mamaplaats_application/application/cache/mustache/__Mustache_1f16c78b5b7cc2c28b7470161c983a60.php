...
class __Mustache_1f16c78b5b7cc2c28b7470161c983a60 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '				<input type="text" name="title" id="title" placeholder="Een duidelijke en unieke titel voor je blog" value="Hoera: Dochtertje VOOR JACK OSBOURNE" maxlength="55">';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '				<textarea class="textarea_count" name="excerpt" id="excerpt" placeholder="Een duidelijke en korte inleiding waarover je blog gaat" maxlength="140">Lisa en Jack Osbourne zijn helemaal gelukkig met de geboorte van dochtertje Andy Rose. </textarea>';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '				<textarea id="redactor_blog" name="content" data-blog-id="98595"><h2>Andy Rose</h2><p>De kleine Andy Rose is het zusje van de 3-jarige Pearl. In februari maakte het stel de zwangerschap bekend. "Verrassing! Ronde 2. Baby op komst", schreef de 29-jarige zoon van rocker Ozzy Osbourne toen op Instagram.</p><p>Bron: <a href="http://www.rtlnieuws.nl/boulevard/entertainment/dochtertje-voor-jack-osbourne">RTLnieuws</a></p><h2>Ook leuk: 13x net voordat het mis gaat</h2><p><a href="http://www.mamaplaats.nl/blog/13-x-net-voordat-het-mis-gaat"><img src="http://www.mamaplaats.nl/wordpress/wp-content/uploads/2015/05/banner1.jpg" alt="banner" width="750" height="312" class="aligncenter size-full wp-image-97913" /></a> </p></textarea>';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '							<img src="http://www.mamaplaats.nl/wordpress/wp-content/uploads/2015/06/111.png">';
        $buffer .= "\n";
        $buffer .= $indent . '						</span>';
        $buffer .= "\n";
        $buffer .= $indent . '					</div>';
        ...
        $buffer .= $indent . '					<div class="form-item blog-form-btns">';
        $buffer .= "\n";
        $buffer .= $indent . '						<a href="/blog/hoera-dochtertje-voor-jack-osbourne" class="btn" target="_blank">Blog Bekijken</a>';
        $buffer .= "\n";
        $buffer .= $indent . '					</div>';
        $buffer .= "\n";
        $buffer .= $indent . '				</div>';
