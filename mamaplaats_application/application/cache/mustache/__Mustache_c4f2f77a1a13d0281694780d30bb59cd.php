...
class __Mustache_c4f2f77a1a13d0281694780d30bb59cd extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= $indent . '			<h3><a href="/lid/ashwinig">';
        $buffer .= "\n";
        $buffer .= $indent . '			    ';
        $buffer .= "\n";
        $buffer .= $indent . '                    ';
        ...
        $buffer .= "\n";
        $buffer .= $indent . '			<a href="#" data-follow-id="117696" class="btn follow btn-with-stars">Volgen</a>';
        $buffer .= "\n";
        $buffer .= $indent . '		</div>';
        $buffer .= "\n";
        $buffer .= $indent . '	</div>';
