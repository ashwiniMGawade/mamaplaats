...
class __Mustache_9414ed49c26130e62449242037423c39 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        // 'show_script' section
        $buffer .= $this->section4c1f0ebdbd838efbaaf7a28171cd71a4($context, $indent, $context->find('show_script'));
    ...
    private function section4c1f0ebdbd838efbaaf7a28171cd71a4(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
    {{show_script}}
';
            ...
            foreach ($values as $value) {
                $context->push($value);
                $buffer .= $indent . '    ';
                $value = $context->find('show_script');
                if (!is_string($value) && is_callable($value)) {
                    $value = $this->mustache
                        ->loadLambda((string) call_user_func($value))
                        ->renderInternal($context, $indent);
