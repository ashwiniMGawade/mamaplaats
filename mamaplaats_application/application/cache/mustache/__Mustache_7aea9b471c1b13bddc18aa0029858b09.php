...
class __Mustache_7aea9b471c1b13bddc18aa0029858b09 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section6d8a8801ff0c742fee158734631466e9($context, $indent, $context->find('profile_complete'));
        $buffer .= $indent . '</div>';
    ...
    private function section55e423fe902573d56c6c864e8dbaa850(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
							<img src="{{get_thumbnail}}">
							';
            $buffer .= $this->mustache
                ->loadLambda((string) call_user_func($value, $source))
                ->renderInternal($context, $indent);
            ...
            foreach ($values as $value) {
                ...
                $value = $context->find('get_thumbnail');
                if (!is_string($value) && is_callable($value)) {
                    $value = $this->mustache
                        ->loadLambda((string) call_user_func($value))
                        ->renderInternal($context, $indent);
    ...
    private function section6d8a8801ff0c742fee158734631466e9(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
	...
	';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section55e423fe902573d56c6c864e8dbaa850($context, $indent, $context->findDot('blog.thumbnail'));
