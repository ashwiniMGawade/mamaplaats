...
class __Mustache_d1831bcd9423afd8db05c183f4bf48d4 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        // 'author' section
        $buffer .= $this->section4474a2aa8b17adeedd646913b1ea625f($context, $indent, $context->find('author'));
    ...
    private function section4474a2aa8b17adeedd646913b1ea625f(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
<div id="two-cols">
