...
class __Mustache_1f4b9795ef6e9c856766b50efc39628c extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $indent . '                            <div class="list-group">';
        $buffer .= "\n";
        $buffer .= $indent . '                                    <a href="https://dev.mamaplaats.nl/" class="list-group-item ">';
        $buffer .= "\n";
        ...
        $buffer .= $indent . '                </p>';
        $buffer .= "\n";
        $buffer .= $indent . '                <p>Je hoort het vaak: &#039;Goh, wat lijkt jouw dochtertje op je zeg!&#039; Maar de volgende foto&#039;s zullen je ech...</p>';
        $buffer .= "\n";
        $buffer .= $indent . '            </article>';
        $buffer .= "\n";
        $buffer .= $indent . '            <article class="item">';
        ...
        $buffer .= $indent . '                </p>';
        $buffer .= "\n";
        $buffer .= $indent . '                <p>Dit recept is bedoelt als flink voorgerecht of klein hoofdgerecht voor 4 (volwassen)personen. De ber...</p>';
        $buffer .= "\n";
        $buffer .= $indent . '            </article>';
        $buffer .= "\n";
        $buffer .= $indent . '    </div>';
