...
class __Mustache_29379a69ca1490f984f84d9ebbbb6c53 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '			<textarea name="content" placeholder="JOUW BERICHT *" rows="5" cols="50">test me here</textarea>';
        $buffer .= "\n";
