...
class __Mustache_a517d84b841da3b530b2d71550797707 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section265e8f8d75bd93afa5e587e762b5934e($context, $indent, $context->find('profile_complete'));
        $buffer .= $indent . '</div>';
    ...
    private function section265e8f8d75bd93afa5e587e762b5934e(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
		...
		<fieldset>
			...
			<div class="form-item">
				...
				<div class="select-wrap">
					<select id="category" name="parent_category_id">
						{{#categories}}
						<option value="{{value}}"
							{{#selected}}selected{{/selected}}
							{{#disabled}}disabled{{/disabled}}>{{& text}}</option>
	...
	';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= "\n";
                $buffer .= $indent . '					<select id="category" name="parent_category_id">';
                $buffer .= "\n";
                // 'categories' section
