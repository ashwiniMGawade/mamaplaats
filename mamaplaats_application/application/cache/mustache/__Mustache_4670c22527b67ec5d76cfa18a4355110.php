...
class __Mustache_4670c22527b67ec5d76cfa18a4355110 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->sectionBbc514f5efafd8054bc24bd0f0e8909b($context, $indent, $context->find('profile_complete'));
        $buffer .= $indent . '</div>';
    ...
    private function sectionC5e7cc882e3911e2f7f5fab2591cb5dd(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
                            {{value}}
    ...
    private function sectionBbc514f5efafd8054bc24bd0f0e8909b(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
		...
		<fieldset>
			...
			<div class="form-item">
				...
				<div class="select-wrap">
					<select id="parent-category" name="parent_category_id" placeholder="Select Category">
						{{#parent_categories}}
						<option value="{{value}}"
							{{#selected}}selected{{/selected}}
							{{#disabled}}disabled{{/disabled}}>{{& text}}</option>
            ...
            <div class="form-item">
                <label for="category">In welke sub categorie behoort deze blog?</label>
                <div class="select-wrap">
	...
	';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= "\n";
                $buffer .= $indent . '					<select id="parent-category" name="parent_category_id" placeholder="Select Category">';
                $buffer .= "\n";
                // 'parent_categories' section
                $buffer .= $this->section79252d2b10d54fd6afdf6b2819edbe1c($context, $indent, $context->find('parent_categories'));
                ...
                $buffer .= $this->sectionC5e7cc882e3911e2f7f5fab2591cb5dd($context, $indent, $context->find('sub_categories'));
                $buffer .= $indent . '                    </select>';
                $buffer .= "\n";
                $buffer .= $indent . '                </div>';
                $buffer .= "\n";
