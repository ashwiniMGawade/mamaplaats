...
class __Mustache_1eb21e198c98b502a25ed35cd5fd8101 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'menu' section
        $buffer .= $this->section5a7fa90c1bf84449e25a6a14b9eb6673($context, $indent, $context->find('menu'));
        $buffer .= $indent . '                    </div>';
        $buffer .= "\n";
        $buffer .= $indent . '				</div>';
        $buffer .= "\n";
    ...
    private function section5bf511799cda279bc29020e51700465c(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
                                    <a href="{{path}}" class="list-group-item {{#active}}active{{/active}}">{{text}}</a>
								';
            $buffer .= $this->mustache
                ->loadLambda((string) call_user_func($value, $source))
                ->renderInternal($context, $indent);
    ...
    private function section5a7fa90c1bf84449e25a6a14b9eb6673(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
                        <nav class="ad-menu">
            ...
            foreach ($values as $value) {
                ...
                $buffer .= "\n";
                // 'sub_menu' section
                $buffer .= $this->section5bf511799cda279bc29020e51700465c($context, $indent, $context->find('sub_menu'));
                $buffer .= $indent . '                            </div>';
                $buffer .= "\n";
                $buffer .= $indent . '                        </nav>';
                $buffer .= "\n";
