...
class __Mustache_512ed97b1383e7702700d8e22c0e0981 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $indent . '                <figure class="photo">';
        $buffer .= "\n";
        $buffer .= $indent . '                    <a class="photo-wrap" href="/blog/test-image-blog-with-embedded-images">';
        $buffer .= "\n";
        ...
        $buffer .= $indent . '                    <a href="/lid/mamaplaats">Mamaplaats</a> -';
        $buffer .= "\n";
        $buffer .= $indent . '                    <time datetime="2015-09-02 15:17:52"> 2 Sep 2015</time>';
        $buffer .= "\n";
        $buffer .= $indent . '                </p>';
        $buffer .= "\n";
        $buffer .= $indent . '                <p>...</p>';
        ...
        $buffer .= $indent . '                <figure class="photo">';
        $buffer .= "\n";
        $buffer .= $indent . '                    <a class="photo-wrap" href="/blog/image-test-on-mamaplaats-for-amazon-s3">';
        $buffer .= "\n";
        $buffer .= $indent . '                        <b><img alt="" src="http://dev.mamaplaats.nl/image/no-image_230xn.png" width="230" height="140"></b>';
        $buffer .= "\n";
        $buffer .= $indent . '                    </a>';
        ...
        $buffer .= $indent . '                </p>';
        $buffer .= "\n";
        $buffer .= $indent . '                <p>image test on mamaplaats for amazon s3 image test on mamaplaats for amazon s3 image test on mamaplaa...</p>';
        $buffer .= "\n";
        $buffer .= $indent . '            </article>';
        $buffer .= "\n";
        $buffer .= $indent . '    </div>';
