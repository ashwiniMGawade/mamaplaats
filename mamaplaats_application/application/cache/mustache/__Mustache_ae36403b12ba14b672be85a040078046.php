...
class __Mustache_ae36403b12ba14b672be85a040078046 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        // 'product' section
        $buffer .= $this->section5f7a0bb5c5ca00317e352c53f05503ed($context, $indent, $context->find('product'));
    ...
    private function section5f7a0bb5c5ca00317e352c53f05503ed(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
<div class="row-fluid">
		...
		<div class="box span12">
			...
			<div class="box-content">
				...
				<div class="row-fluid">
					...
					<div>
						<img class="img-polaroid" width="150" src="{{product_image_url}}" alt="Voorbeeld Foto">
						<br/>
						<br/>
					</div>
				</div>
...
';
            ...
            foreach ($values as $value) {
                ...
                $value = $context->find('product_image_url');
                if (!is_string($value) && is_callable($value)) {
                    $value = $this->mustache
                        ->loadLambda((string) call_user_func($value))
                        ->renderInternal($context, $indent);
