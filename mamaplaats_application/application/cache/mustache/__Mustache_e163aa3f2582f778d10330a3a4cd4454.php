...
class __Mustache_e163aa3f2582f778d10330a3a4cd4454 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '				<input type="text" name="title" id="title" placeholder="Een duidelijke en unieke titel voor je blog" value="test 12121ss" maxlength="55">';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '				<textarea class="textarea_count" name="excerpt" id="excerpt" placeholder="Een duidelijke en korte inleiding waarover je blog gaat" maxlength="140">adfasdf asdfsadf </textarea>';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '				<textarea id="redactor_blog" name="content" data-blog-id="98730"><p>asdfsadfsadfs</p></textarea>';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= "\n";
        ...
        $buffer .= $indent . '					<div class="form-item blog-form-btns">';
        $buffer .= "\n";
        $buffer .= $indent . '                            <a href="/user/blog/delete/98730" class="btn" onclick="return confirm(\'Weet je zeker dat je \\\'test 12121ss\\\' wil verwijderen?\');">Verwijder</a>';
        $buffer .= "\n";
        $buffer .= $indent . '					</div>';
        $buffer .= "\n";
        $buffer .= $indent . '				</div>';
