...
class __Mustache_bf5fecbad639ef65f946ec08389f7dda extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $indent . '</div>';
        $buffer .= "\n";
        // 'is_draft_message' section
        $buffer .= $this->section8a7a7ae3993c23b270cf279c74aa27ef($context, $indent, $context->find('is_draft_message'));
    ...
    private function section8a7a7ae3993c23b270cf279c74aa27ef(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
    ...
    <div class="msg-box">
        <form action="" method="post">
            <fieldset>
                <input name="recipient_id" type="hidden" value="{{partner_id}}">
                <textarea name="content" placeholder="JOUW REACTIE *" rows="5" cols="50"></textarea>
