...
class __Mustache_cb4bb2bd3042554e5e4c51a229dabe4b extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'blog_list' section
        $buffer .= $this->section294cac666ca26c25aff81c4afdcd1660($context, $indent, $context->find('blog_list'));
        $buffer .= $indent . '    </div>';
        $buffer .= "\n";
    ...
    private function section294cac666ca26c25aff81c4afdcd1660(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <article class="item">
                ...
                <p>{{blog.excerpt}}</p>
                <a href="/user/blog/{{blog.id}}">Bewerken Blog</a>
            </article>
		';
            $buffer .= $this->mustache
                ->loadLambda((string) call_user_func($value, $source))
            ...
            foreach ($values as $value) {
                ...
                $buffer .= '</p>';
                $buffer .= "\n";
                $buffer .= $indent . '                <a href="/user/blog/';
