...
class __Mustache_ac73fa144e72f4839def6c17fa26a717 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section65d46501cc1367a097b9d2cf1b19e703($context, $indent, $context->find('conversation_list'));
    ...
    private function section65d46501cc1367a097b9d2cf1b19e703(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
