...
class __Mustache_6e44fe53c6feedad2144fadf211df772 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'blog' section
        $buffer .= $this->section58b491e54e43ea9f4a590c80fabd05ba($context, $indent, $context->find('blog'));
    ...
    private function section3107fbf12fdf0e2f707355546e11819e(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
				<a href="/user/blog/index/{{id}}">Blog Bewerken</a>
				';
            $buffer .= $this->mustache
                ->loadLambda((string) call_user_func($value, $source))
                ->renderInternal($context, $indent);
    ...
    private function section58b491e54e43ea9f4a590c80fabd05ba(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            ...
            foreach ($values as $value) {
                ...
                $buffer .= "\n";
                // 'show_edit_link' section
                $buffer .= $this->section3107fbf12fdf0e2f707355546e11819e($context, $indent, $context->find('show_edit_link'));
