...
class __Mustache_bfc1de3473da146de1f3364774763c3a extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'user' section
        $buffer .= $this->section9ee61f53f13a67f1fa751a8c42c9b918($context, $indent, $context->find('user'));
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= $indent . '		</div>';
        $buffer .= "\n";
    ...
    private function sectionF45049d147d65f8401155450df69310c(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
						{{#default}}
    ...
    private function section9ee61f53f13a67f1fa751a8c42c9b918(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            ...
            foreach ($values as $value) {
                ...
                $buffer .= "\n";
                // 'success' section
                $buffer .= $this->sectionF45049d147d65f8401155450df69310c($context, $indent, $context->find('success'));
