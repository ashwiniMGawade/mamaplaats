...
class __Mustache_56e801827309696b2a9cb7b0a2e9a902 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '				<textarea id="redactor_blog" name="content" data-blog-id="98595"><h2>Andy Rose</h2>';
        $buffer .= "\n";
        $buffer .= $indent . '<p>De kleine Andy Rose is het zusje van de 3-jarige Pearl. In februari maakte het stel de zwangerschap bekend. "Verrassing! Ronde 2. Baby op komst", schreef de 29-jarige zoon van rocker Ozzy Osbourne toen op Instagram.</p>';
        $buffer .= "\n";
        $buffer .= $indent . '';
        $buffer .= "\n";
        $buffer .= $indent . '<p>Bron: <a href="http://www.rtlnieuws.nl/boulevard/entertainment/dochtertje-voor-jack-osbourne" target="_blank">RTLnieuws</a></p>';
        $buffer .= "\n";
        $buffer .= $indent . '<h2>Ook leuk: 13x net voordat het mis gaat</H2>';
        $buffer .= "\n";
        $buffer .= $indent . '<p><a href="http://www.mamaplaats.nl/blog/13-x-net-voordat-het-mis-gaat"><img src="http://www.mamaplaats.nl/wordpress/wp-content/uploads/2015/05/banner1.jpg" alt="banner" width="750" height="312" class="aligncenter size-full wp-image-97913" /></a> </p></textarea>';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= "\n";
        ...
        $buffer .= $indent . '					<div class="form-item blog-form-btns">';
        $buffer .= "\n";
        $buffer .= $indent . '						<a href="/blog/jack-osbourne" class="btn" target="_blank">Blog Bekijken</a>';
        $buffer .= "\n";
        $buffer .= $indent . '					</div>';
        $buffer .= "\n";
        $buffer .= $indent . '				</div>';
