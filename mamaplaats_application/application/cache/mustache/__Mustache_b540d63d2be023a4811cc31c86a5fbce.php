...
class __Mustache_b540d63d2be023a4811cc31c86a5fbce extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= "\n";
        $buffer .= $indent . '        <!-- VMG NL Young Family Media mamaplaats.nl mamaplaats.nl inpagevideo-->';
        $buffer .= "\n";
        $buffer .= $indent . '        <div id="inPageVideo"></div>';
        $buffer .= "\n";
        $buffer .= $indent . '        <script  type="text/javascript" async src="//nl.vmg.host/adServ/placement/id/2249"></script>';
        $buffer .= "\n";
        $buffer .= $indent . '        <!-- end  VMG NL -->';
        $buffer .= "\n";
