...
class __Mustache_357c356cb5e146c8731014abc4ff0e23 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '		<div class="col-sm-3 blog-sidebar">';
        $buffer .= "\n";
        ...
        $buffer .= $indent . '		</div>';
        $buffer .= "\n";
        $buffer .= $indent . '		<div class="col-md-9 col-sm-12">';
        $buffer .= "\n";
        $buffer .= $indent . '			';
