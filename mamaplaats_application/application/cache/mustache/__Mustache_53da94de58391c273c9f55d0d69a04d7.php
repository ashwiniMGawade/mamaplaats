...
class __Mustache_53da94de58391c273c9f55d0d69a04d7 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '			<a href="/lid/megamama" class="photo-wrap">';
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '                <strong class="title"><a href="/lid/megamama">MegaMama</a></strong>';
        $buffer .= "\n";
        $buffer .= $indent . '            </div>';
        $buffer .= "\n";
        $buffer .= $indent . '            <p>Hoi :-)';
        $buffer .= "\n";
        $buffer .= "\n";
        $buffer .= $indent . 'Ik zou enorm graag mee willen doen met de actie &quot;win een bakfiets&quot; maar kan nergens de mogelijkheid vinden om mijn verhaal in te vullen. Onderaan de pagina komt een soort van foutmelding en ik weet niet wat ik verkeerd doe. Misschien kunnen jullie helpen?';
        $buffer .= "\n";
        $buffer .= "\n";
        $buffer .= $indent . 'Bij voorbaat enorm bedankt en hele fijne Feestdagen!';
        $buffer .= "\n";
        $buffer .= "\n";
        $buffer .= $indent . 'Groetjes,';
        $buffer .= "\n";
        $buffer .= "\n";
        $buffer .= $indent . 'Karin van den Berg';
        $buffer .= "\n";
        $buffer .= $indent . 'handsoflove@home.nl';
        $buffer .= "\n";
        $buffer .= $indent . '0629921850</p>';
        $buffer .= "\n";
        $buffer .= $indent . '        </div>';
        $buffer .= "\n";
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '                <input name="recipient_id" type="hidden" value="65128">';
        $buffer .= "\n";
