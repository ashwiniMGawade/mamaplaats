...
class __Mustache_dbb8e3b30917ff1b7ea05ddb95e22bf3 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section09e1464cf6893d024c9039f79c763a16($context, $indent, $context->find('conversation_list'));
    ...
    private function section09e1464cf6893d024c9039f79c763a16(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
			<label class="item alt">
				...
				<span class="photo">
					<a href="/conversation/index/{{conversation_partner.id}}" class="photo-wrap">
