...
class __Mustache_89a25ad535e9255723475f8d2420ec0c extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '		<input id="recipient" type="text" name="search-term" value="Mamaplaats" placeholder="Zoek een moeder op voornaam, achternaam of gebruikersnaam" autocomplete="off">';
        $buffer .= "\n";
        $buffer .= $indent . '	</form>';
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '			<input id="recipient_id" name="recipient_id" type="hidden" value="1">';
        $buffer .= "\n";
        $buffer .= $indent . '			<textarea name="content" placeholder="JOUW BERICHT *" rows="5" cols="50">test with concept-&gt; new concept new</textarea>';
        $buffer .= "\n";
