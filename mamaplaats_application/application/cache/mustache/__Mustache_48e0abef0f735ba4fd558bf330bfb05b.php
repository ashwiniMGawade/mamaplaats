...
class __Mustache_48e0abef0f735ba4fd558bf330bfb05b extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '						<img class="img-polaroid" width="180" src="http://dev.mamaplaats.nl/image/no-image_180x180.png" alt="Voorbeeld Foto"><br><br>';
        $buffer .= "\n";
        $buffer .= "\n";
