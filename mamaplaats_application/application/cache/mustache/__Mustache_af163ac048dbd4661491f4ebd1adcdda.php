...
class __Mustache_af163ac048dbd4661491f4ebd1adcdda extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '				Uitgelichte foto moet gevuld zijn<br />Titel moet gevuld zijn<br />Korte Omschrijving moet gevuld zijn<br />Blog inhoud moet gevuld zijn<br />';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        ...
        $buffer .= "\n";
        $buffer .= $indent . '				<textarea id="redactor_blog" name="content" data-blog-id="98733"></textarea>';
        $buffer .= "\n";
        $buffer .= $indent . '			</div>';
        $buffer .= "\n";
        $buffer .= "\n";
        ...
        $buffer .= $indent . '					<div class="form-item blog-form-btns">';
        $buffer .= "\n";
        $buffer .= $indent . '                            <a href="/user/blog/delete/98733" class="btn" onclick="return confirm(\'Weet je zeker dat je \\\'\\\' wil verwijderen?\');">Verwijder</a>';
        $buffer .= "\n";
        $buffer .= $indent . '					</div>';
        $buffer .= "\n";
        $buffer .= $indent . '				</div>';
