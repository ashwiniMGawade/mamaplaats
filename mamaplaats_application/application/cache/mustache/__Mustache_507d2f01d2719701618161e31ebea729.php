...
class __Mustache_507d2f01d2719701618161e31ebea729 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'blocks' section
        $buffer .= $this->section8c15f63b7fb3d81b30d0f3f7304dd7e0($context, $indent, $context->find('blocks'));
        $buffer .= $indent . '	</div>';
        $buffer .= "\n";
    ...
    private function section8c15f63b7fb3d81b30d0f3f7304dd7e0(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            {{four.title}}
