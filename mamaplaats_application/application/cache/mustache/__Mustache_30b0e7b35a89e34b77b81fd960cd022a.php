...
class __Mustache_30b0e7b35a89e34b77b81fd960cd022a extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'user' section
        $buffer .= $this->section52a97134a9c14d86b1d7d22ed7705c0c($context, $indent, $context->find('user'));
        $buffer .= "\n";
    ...
    private function section52a97134a9c14d86b1d7d22ed7705c0c(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
<table border="0" cellpadding="10" cellspacing="0" style="width: 100%">
    <tr style="border-bottom: 1px solid #CCCCCC;">
        ...
        <td>
            ...
            <p>Volg jij {{follower_name}} al? <a href="{{user_link}}">Klik hier en volg</a></p>
