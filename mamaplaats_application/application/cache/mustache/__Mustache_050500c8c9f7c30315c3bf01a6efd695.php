...
class __Mustache_050500c8c9f7c30315c3bf01a6efd695 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $this->section85a2ca054627bb08433c04ba9c6eca05($context, $indent, $context->find('conversation_list'));
    ...
    private function section85a2ca054627bb08433c04ba9c6eca05(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
			<label class="item alt">
				...
				<span class="photo">
					<a href="/conversation/index/{{conversation_partner.id}}{{#conversation_partner.draft}}?type=draft{{/conversation_partner.draft}}" class="photo-wrap">
				...
				<span class="description">
					<span class="wrap">
						...
						<strong class="title">
							<a href="/conversation/index/{{conversation_partner.id}}">
            ...
            foreach ($values as $value) {
                ...
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                // 'conversation_partner.draft' section
                $buffer .= $this->sectionDac32392f0db71436738397bd7c19625($context, $indent, $context->findDot('conversation_partner.draft'));
