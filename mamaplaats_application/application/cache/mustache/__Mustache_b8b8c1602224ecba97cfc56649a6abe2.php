...
class __Mustache_b8b8c1602224ecba97cfc56649a6abe2 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'blog' section
        $buffer .= $this->sectionD1d3affba71e4378df37bc4e0df78cae($context, $indent, $context->find('blog'));
    ...
    private function sectionBaf648a352bf88667fa043583106e773(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
				<a href="/user/blog/index/{{id}}">Bewerken Blog</a>
				';
            $buffer .= $this->mustache
                ->loadLambda((string) call_user_func($value, $source))
                ->renderInternal($context, $indent);
    ...
    private function sectionD1d3affba71e4378df37bc4e0df78cae(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionBaf648a352bf88667fa043583106e773($context, $indent, $context->find('show_edit_link'));
