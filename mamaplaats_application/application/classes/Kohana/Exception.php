 ...
 *
 * IMPORTANT note by Robert-Jan de Dreu:
 * I copied this file from the airbrake module. The reason is that exceptions need to be loaded before
 * the modules are loaded. Since application loads first this is the right spot for it.
 *
 * @package  Airbrake
 */
