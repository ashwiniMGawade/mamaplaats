...
class Usecase_Admin_AddAdvertisementPopup {
	...
	public function execute(Entity_Setting_AdvertisementPopup $advertisement)
	{
		...
		{
			throw new Validate_Exception('Invalid date range', array('End date must be greater than or equal to start date.'));
		}

		$this->_repository_advertisement_popup->create($advertisement);
	}
